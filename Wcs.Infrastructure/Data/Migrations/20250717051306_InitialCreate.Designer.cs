...
namespace Wcs.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250717051306_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wcs.Domain.ExecuteNodePath", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Wcs.Domain.JobConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wcs.Domain.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wcs.Domain.TaskExecuteStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wcs.Domain.ExecuteNodePath", b =>
                {
                    b.HasOne("Wcs.Domain.Region", "Region")
                        .WithOne()
                        .HasForeignKey("Wcs.Domain.ExecuteNodePath", "RegionId");
            ...
            modelBuilder.Entity("Wcs.Domain.Task.WcsTask", b =>
                {
                    b.HasOne("Wcs.Domain.TaskExecuteStep", "TaskExecuteStep")
                        .WithMany()

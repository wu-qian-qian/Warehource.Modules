...
namespace Wcs.Application.DeviceHandler.Behaviors.GetTask;

public class GetWcsTaskPipelinBehavior
    : IPipelineBehavior<GetWcsTaskEvent, IEnumerable<WcsTask>>
{
    public async Task<IEnumerable<WcsTask>> Handle(GetWcsTaskEvent request,

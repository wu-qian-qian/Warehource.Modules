...
namespace Wcs.Application.DeviceHandler.GetWcsTask;
...
public class GetWcsTaskHandler(
    IWcsTaskRepository _taskRepository)
    : IQueryHandler<GetWcsTaskEvent, IEnumerable<WcsTask>>
{
    public Task<IEnumerable<WcsTask>> Handle(GetWcsTaskEvent request, CancellationToken cancellationToken)
    {
        //只获取

...
[StateAttrubite($"{nameof(DeviceTypeEnum.StackerInTranShip)}-{nameof(TaskExecuteStepTypeEnum.Complate)}")]
internal class ComplateFSM(ISender _sender, ICacheService _cacheService, IStackerTranshipInController _controller)
    : IStateMachine
{

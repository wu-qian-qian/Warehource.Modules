...
[StateAttrubite($"{nameof(DeviceTypeEnum.StackerOutTranShip)}-{nameof(TaskExecuteStepTypeEnum.Complate)}")]
internal class ComplateFSM(ISender _sender, ICacheService _cacheService, IStackerTranshipOutController _controller)
    : IStateMachine
{

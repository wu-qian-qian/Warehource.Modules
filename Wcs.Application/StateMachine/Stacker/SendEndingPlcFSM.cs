...
[StateAttrubite($"{nameof(DeviceTypeEnum.Stacker)}-{nameof(TaskExecuteStepTypeEnum.SendEndingPlc)}")]
internal class SendEndingPlcFSM(ICacheService _cacheService, IStackerController _controller) : IStateMachine
{

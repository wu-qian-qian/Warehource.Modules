...
internal class DeleteJobCommandHandler(
    ...
    IMapper mapper) : ICommandHandler<DeleteJobCommand, Result<JobDto>>
{
    public async Task<Result<JobDto>> Handle(DeleteJobCommand request, CancellationToken cancellationToken)
    {

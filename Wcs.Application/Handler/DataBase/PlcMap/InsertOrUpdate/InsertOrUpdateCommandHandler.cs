...
internal class InsertOrUpdateCommandHandler(IUnitOfWork _unitOfWork, IPlcMapRepository _plcMapRepository)
    : ICommandHandler<InsertOrUpdateCommand>
{
    public async Task Handle(InsertOrUpdateCommand request, CancellationToken cancellationToken)
    {
